...
public class TravelLogicService {
    ...
    public String recommend(TravelSurveyRequest request, User user) {
        ...
        if (budgetValue >= 100 && lifestyle.contains("자유로운") && weather.contains("따뜻") && safety.contains("안전")) {
            result = "치앙마이";
        } else if (budgetValue >= 100 && lifestyle.contains("자유로운") && weather.contains("따뜻") && safety.contains("위험")) {
            result = "세부";
        } else if (budgetValue >= 100 && lifestyle.contains("자유로운") && weather.contains("따뜻") && safety.contains("매우")) {
            result = "조호바루";
        } else if (budgetValue >= 150 && lifestyle.contains("자유로운") && weather.contains("따뜻") && safety.contains("안전")) {
            result = "발리";
        } else if (budgetValue >= 100 && lifestyle.contains("자유로운") && weather.contains("따뜻") && safety.contains("위험")) {
            result = "쿠알라룸푸르";
            ...
            result = "부다페스트";
        } else if (budgetValue >= 200 && lifestyle.contains("자유로운") && weather.contains("따뜻") && safety.contains("매우")) {
            result = "브리즈번";
        } else if (budgetValue >= 150 && lifestyle.contains("디자인") && weather.contains("서서") && safety.contains("안전")) {
            result = "포르투";
        } else {
